...
export function ProjectsExplorerPage() {
  ...
  return (
    <div className="space-y-6">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-3.5">
          ...
          <div className="relative">
            ...
            <input
              ...
              placeholder="Search code, title, contractor..."
      ...
      <Card>
        <CardHeader>
          <CardTitle>Civil Works Portfolio ({projects.length} works found)</CardTitle>
        </CardHeader>
        <CardContent>
          <Table>
            <TableHeader>
                    ...
                    <TableRow key={p.id}>
                      ...
                      <TableCell>
                        ...
                        <div className="text-[10px] text-[#6B6B6B]">
                          Contractor: {p.contractor.name} • {p.district}, {p.state}
                        </div>
                      </TableCell>
                      <TableCell>
                        ...
                        <div className="flex items-center gap-2">
                          ...
                          <div className="w-16 h-1.5 rounded-full bg-black/5 overflow-hidden hidden sm:block">
                            <div
                              ...
                              style={{ width: `${p.physicalProgressPercentage}%` }}
                            />
                          </div>
                        </div>
                      </TableCell>
