        ...
        >
          ...
          <div className="relative z-10 flex flex-col items-center max-w-md w-full px-6 text-center">
            ...
            <div className="relative mb-6">
              ...
              <div className="w-16 h-16 rounded-full bg-white flex items-center justify-center shadow-lg border border-[#E5E3DC] p-3">
                <SanchayLogo className="w-full h-full object-contain" variant="auto" />
              </div>
            </div>
            ...
            <div className="space-y-1 mb-6">
              ...
              <h2 className="text-xl font-extrabold tracking-tight text-[#0E0E0E] uppercase font-sans">
                SANCHAY
              </h2>
