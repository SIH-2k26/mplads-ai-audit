...
export function IntelligencePipelineSection() {
  ...
  return (
    <section id="pipeline" className="py-24 bg-white border-b border-[#D9D5CC]">
          ...
          {steps.map((step, idx) => {
            ...
            return (
              <div
                ...
                className={`rounded-[6px] border border-[#D9D5CC] bg-[#FAFAF7] p-5 shadow-card transition-all flex flex-col justify-between border-l-4 ${step.color} ${
                  isHovered ? 'bg-white shadow-elevated scale-[1.02] border-[#18324A]' : ''
                }`}
              >
                <div>
                  ...
                  <p className="text-[11px] text-[#667085] leading-relaxed mb-4">
                    {step.desc}
                  </p>
                  ...
                  <div className="space-y-2 pt-3 border-t border-[#EDE8DE]">
                    {step.items.map((item, itemIdx) => (
                      ...
                      >
                        <span className="text-[#C98219] font-bold">•</span>
                        <span>{item}</span>
                      </div>
                    ))}
                  </div>
                ...
                <div className="mt-6 pt-3 border-t border-[#EDE8DE] text-[10px] font-mono text-[#667085] flex items-center justify-between">
