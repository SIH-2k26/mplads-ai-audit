        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 items-center">
          ...
          <div className="lg:col-span-5 space-y-4">
            ...
            <h2 className="text-3xl sm:text-4xl lg:text-5xl font-extrabold text-[#002449] tracking-tight uppercase leading-tight font-sans">
              Every Project. <br />
              <span className="text-[#002449]">One Digital Twin.</span>
            </h2>
          ...
          <div className="lg:col-span-7">
            <div className="rounded-[8px] border-2 border-[#002449] bg-white p-6 shadow-2xl space-y-4">
              
              {/* Header Badge */}
              <div className="flex items-start justify-between border-b border-[#E5E3DC] pb-4">
                <div>
                  <span className="text-[10px] font-mono font-bold uppercase tracking-wider text-[#002449] block">
                    PROJECT DIGITAL TWIN ARTIFACT
                  </span>
                  <h3 className="text-base sm:text-lg font-bold text-[#002449]">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 bg-[#FAFAF9] p-3.5 rounded border border-[#E5E3DC] text-xs">
                <div>
                  <span className="text-[10px] text-[#6B6B6B] uppercase tracking-wider block">Sanctioned Outlay</span>
                  <strong className="text-sm font-mono text-[#002449]">₹42.0 Lakhs</strong>
                </div>
                <div>
                  <span className="text-[10px] text-[#6B6B6B] uppercase tracking-wider block">Physical Execution</span>
                  <strong className="text-sm font-mono text-[#002449]">82.0% Verified</strong>
                </div>
                <div>
                  <span className="text-[10px] text-[#6B6B6B] uppercase tracking-wider block">Disbursed Funds</span>
              ...
              {/* Footer */}
              <div className="pt-3 border-t border-[#E5E3DC] flex items-center justify-between text-xs text-[#6B6B6B]">
