...
export function LandingFooter() {
  return (
    <footer className="bg-[#102A43] text-gray-300 border-t border-[#18324A] text-xs">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-14">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-10">
          ...
          <div className="space-y-3 md:col-span-1">
            ...
            <span className="inline-block rounded bg-[#D89425]/20 px-2 py-0.5 text-[9px] font-mono font-bold text-[#E5B45A] border border-[#D89425]/30">
          ...
          <div className="space-y-2">
            ...
            <div className="pt-2 text-[10px] font-mono text-gray-400 border-t border-[#18324A] space-y-1">
        ...
        <div className="pt-6 border-t border-[#18324A] flex flex-col sm:flex-row items-center justify-between gap-4 text-[11px] text-gray-400">
          <div>
